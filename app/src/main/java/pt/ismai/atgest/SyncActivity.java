...
import pt.ismai.atgest.Api.Clients.GetRemoteClients;
...
public class SyncActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected Button bSyncClients;
    protected ProgressBar pBSyncClients;
    GetRemoteClients tskCompareClients;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bSyncClients = (Button) findViewById(R.id.bSyncClients);
        pBSyncClients = (ProgressBar) findViewById(R.id.pBSyncClients);

        bSyncClients.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                tskCompareClients = new GetRemoteClients(db, bSyncClients, pBSyncClients);
                tskCompareClients.execute();
            }
        });
    }
